...
import com.hrc.pojo.POJO;

/**
 * Servlet implementation class SearchCustNum
 */
@WebServlet(urlPatterns={"/SearchCustNum"},name = "SearchCustNum")
public class SearchCustNum extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchCustNum() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
            ...
            PreparedStatement ps=conn.prepareStatement("select * from winter_internship where cust_number like ?");
